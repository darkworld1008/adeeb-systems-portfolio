...
export default function CustomCursor() {
  ...
  // Motion values for smooth elastic cursor physics
  ...
  useEffect(() => {
    // Check if device is mobile/touch to hide custom cursor
    const checkDevice = () => {
    ...
    // Apply global cursor-none style class to document body
    ...
    <>
      ...
      <motion.div
        ...
        animate={{
          ...
          backgroundColor: isHovered ? "#ff00ff" : "#00ffff",
        }}
        transition={{ type: "spring", stiffness: 400, damping: 25 }}
      />

      {/* 2. Cybernetic Tracking Ring & Outer Crosshair lines */}
      <motion.div
        ...
        animate={{
          scale: isClicked ? 1.5 : isHovered ? 1.25 : 1,
      ...
      >
        ...
        >
          ...
          <motion.circle
            ...
            animate={{
              strokeDashoffset: isHovered ? [0, 40] : [0, -20],
            }}
            transition={{
              repeat: Infinity,
              duration: 2.5,
          ...
          {/* Hover targeting bracket indicator */}
          {isHovered && (
            <>
        ...
        {/* 3. Small label tag overlay next to pointer */}
        {isHovered && hoverType && (
          <motion.div
